...
function cargarGaleriaManifest() {
    if (!_galeriaManifestPromise) {
        ...
        _galeriaManifestPromise = fetch('https://www.woodtools.com.ar/imagenes/herramientas/galeria-manifest.json', { cache: 'no-cache' })
...
function renderizarGaleria(codigoActivo, info) {
    ...
    const defaultLogo = "https://www.woodtools.com.ar/imagenes/logos/WoodTools.png";
    ...
    cargarGaleriaManifest().then(manifest => {
        ...
        carpetasImg.forEach(carpeta => {
            const basePath = `https://www.woodtools.com.ar/imagenes/herramientas/${info.categoriaImg}/${carpeta}/`;
